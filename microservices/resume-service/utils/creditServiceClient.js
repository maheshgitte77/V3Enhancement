...
class CreditServiceClient {
   ...
   * @param {string} actionKey - Action key (e.g., "AI_RESUME_ANALYSIS")
   * @returns {Promise<Object>} Estimation details with cost breakdown
   */
  ...
  /**
   * Estimate costs for multiple AI actions in parallel
